...
python3 tools/train.py --config_file='configs/softmax_supcon.yml' MODEL.DEVICE_ID "('0')" DATASETS.NAMES "('prw')" DATASETS.ROOT_DIR "('/root/workplace/dataset/')" OUTPUT_DIR "('/root/workplace/re-Id/reid-strong-baseline/prw/prw2gt_supconLoss+crossEntropy')"
