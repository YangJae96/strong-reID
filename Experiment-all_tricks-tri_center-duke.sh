...
# bnneck on
# with center loss
python3 tools/train.py --config_file='configs/softmax_triplet_with_center.yml' MODEL.DEVICE_ID "('0')" DATASETS.NAMES "('dukemtmc')" DATASETS.ROOT_DIR "('/root/workplace/dataset/')" OUTPUT_DIR "('/home/workplace/re-Id/reid-strong-baseline/dukemtmc/cuhk_gt/')"
